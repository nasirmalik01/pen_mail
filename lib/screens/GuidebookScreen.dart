...
import 'package:pen_mail_project/screens/FileUploadGuidebook.dart';
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          SpeedDialChild(
              ...
              label: 'Upload file',
              backgroundColor: Color(0xFF54A9FF),
              onTap: () =>
                  Navigator.push(context, MaterialPageRoute(
                      builder: (ctx) => FileUploadGuidebook(token: widget.token)))
          ),
          SpeedDialChild(
